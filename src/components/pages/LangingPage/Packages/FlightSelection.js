...
// const FlightSelection = ({ flights, onFlightSelect, onBack, loading }) => {
...
//           <h1 className="flight-title">Select Your Flight</h1>
//           <p className="flight-subtitle">Choose your preferred onward flight option</p>
//         </div>
