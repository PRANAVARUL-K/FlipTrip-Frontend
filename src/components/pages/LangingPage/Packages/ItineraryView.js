...
// const ItineraryView = ({ flightPlan, spotSchedule, onBack, onConfirm, loading }) => {
...
//               <Plane size={20} />
//               <span>{flightPlan?.length || 0} Inter-city Flight{(flightPlan?.length || 0) !== 1 ? 's' : ''}</span>
//             </div>
//             <div className="summary-item">
//               <MapPin size={20} />
//               <span>
...
//         {(!flightPlan || flightPlan.length === 0) && (!spotSchedule || spotSchedule.length === 0) && (
